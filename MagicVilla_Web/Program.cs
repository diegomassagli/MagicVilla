...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
    .AddCookie(options =>
    {
        ...
        options.LoginPath = "/Usuario/Login";  // adonde se tiene que dirigir cuando queremos que haga login
        options.AccessDeniedPath = "/Usuario/AccesoDenegado"; // y adonde cuando le negamos el acceso
